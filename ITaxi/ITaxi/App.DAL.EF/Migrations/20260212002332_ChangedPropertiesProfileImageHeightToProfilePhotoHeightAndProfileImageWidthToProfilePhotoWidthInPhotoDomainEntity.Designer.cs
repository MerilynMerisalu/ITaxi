...
namespace App.DAL.EF.Migrations
{
    ...
    [Migration("20260212002332_ChangedPropertiesProfileImageHeightToProfilePhotoHeightAndProfileImageWidthToProfilePhotoWidthInPhotoDomainEntity")]
    partial class ChangedPropertiesProfileImageHeightToProfilePhotoHeightAndProfileImageWidthToProfilePhotoWidthInPhotoDomainEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Booking", b =>
                {
                    ...
                    b.Property<int>("DestinationFloorNumber")
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("HasAnElevatorInTheDestinationBuilding")
                        .HasColumnType("bit");

                    b.Property<bool?>("HasAnElevatorInThePickupBuilding")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("NeedAssistanceLeavingTheBuilding")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("PickupFloorNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Domain.DisabilityType", b =>
                {
                    ...
                    b.Property<Guid>("DisabilityTypeNameId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("App.Domain.Drive", b =>
                {
                    ...
                    b.Property<DateTime>("DriveAcceptedDateAndTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DriveDeclineDateAndTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DriveEndDateAndTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DriveStartDateAndTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("IsDriveAccepted")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDriveDeclined")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDriveFinished")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Domain.ExtraService", b =>
                {
                    ...
                    b.Property<Guid>("ExtraServiceNameId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("App.Domain.Photo", b =>
                {
                    ...
                    b.Property<int?>("ProfilePhotoHeight")
                        .HasColumnType("int");

                    b.Property<int?>("ProfilePhotoWidth")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Domain.DisabilityType", b =>
                {
                    b.HasOne("Base.Domain.LangStr", "DisabilityTypeName")
                        .WithMany()
                        .HasForeignKey("DisabilityTypeNameId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DisabilityTypeName");
                });
            ...
            modelBuilder.Entity("App.Domain.ExtraService", b =>
                {
                    b.HasOne("Base.Domain.LangStr", "ExtraServiceName")
                        .WithMany()
                        .HasForeignKey("ExtraServiceNameId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.Domain.RideTime", b =>
                {
                    ...
                    b.HasOne("App.Domain.Driver", null)
                        .WithMany("RideTimes")
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.Domain.VehicleType", b =>
                {
                    b.HasOne("Base.Domain.LangStr", "VehicleTypeName")
                        .WithMany()
                        .HasForeignKey("VehicleTypeNameId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Base.Domain.Translation", b =>
                {
                    b.HasOne("Base.Domain.LangStr", "LangStr")
                        .WithMany("Translations")
                        .HasForeignKey("LangStrId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("LangStr");
                });
