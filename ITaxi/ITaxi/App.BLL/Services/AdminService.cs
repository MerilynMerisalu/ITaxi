    ...
    IAdminService
{
    ...
    {
        var result = await Repository.GetAdminByAppUserIdAsync(appuserId: appuserId, noIncludes: noIncludes, noTracking: noTracking, showDeleted: showDeleted, showIgnored: showIgnored);
