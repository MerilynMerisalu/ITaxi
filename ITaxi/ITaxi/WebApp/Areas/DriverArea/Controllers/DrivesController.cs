...
namespace WebApp.Areas.DriverArea.Controllers
{
    ...
    public class DrivesController : Controller
    {
        ...
        {
            var appDbContext = _context.Drives.Include(d => d.Driver);
        ...
        {
            if (id == null || _context.Drives == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.Drives == null)
            {
                return Problem("Entity set 'AppDbContext.Drives'  is null.");
            }
            var drive = await _context.Drives.FindAsync(id);
            if (drive != null)
            {
        ...
        {
          return (_context.Drives?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
