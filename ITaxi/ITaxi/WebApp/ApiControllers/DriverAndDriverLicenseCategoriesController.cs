...
namespace WebApp.ApiControllers
{
    ...
    public class DriverAndDriverLicenseCategoriesController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDriverAndDriverLicenseCategory(Guid id, DriverAndDriverLicenseCategory driverAndDriverLicenseCategory)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<DriverAndDriverLicenseCategory>> PostDriverAndDriverLicenseCategory(DriverAndDriverLicenseCategory driverAndDriverLicenseCategory)
        {
            _context.DriverAndDriverLicenseCategories.Add(driverAndDriverLicenseCategory);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetDriverAndDriverLicenseCategory", new { id = driverAndDriverLicenseCategory.Id }, driverAndDriverLicenseCategory);
        }
