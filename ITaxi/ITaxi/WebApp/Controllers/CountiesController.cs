...
namespace WebApp.Controllers
{
    public class CountiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CountyName,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt,Id")] County county)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CountyName,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt,Id")] County county)
        {
            if (id != county.Id)
            {
                return NotFound();
