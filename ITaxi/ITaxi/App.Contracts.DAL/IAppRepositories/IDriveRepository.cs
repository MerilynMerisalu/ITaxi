...
public interface IDriveRepositoryCustom<TEntity>
{
    ...
    Task<IEnumerable<TEntity>> GettingAllOrderedDrivesWithIncludesAsync(Guid? userId = null, string? roleName = null,
        bool noTracking = true);

    IEnumerable<TEntity> GettingAllOrderedDrivesWithIncludes(Guid? userId = null, string? roleName = null,
        bool noTracking = true);
    ...
    Task<IEnumerable<TEntity?>> GettingDrivesWithoutCommentAsync(Guid? userId = null, string? roleName = null,
        bool noTracking = true);

    IEnumerable<TEntity?> GettingDrivesWithoutComment(bool noTracking = true);

    Task<IEnumerable<TEntity?>> GettingAllDrivesForCommentsAsync(Guid? userId = null, string? roleName = null,
        bool noTracking = true);
    ...
    Task<TEntity?> GettingFirstDriveAsync(Guid? id, Guid? userId = null, string? roleName = null,
        bool noTracking = true,
    ...
    Task<TEntity?> GettingDriveByBookingIdAsync(Guid bookingId, Guid? userId = null, string? roleName = null,
        bool noTracking = true, bool noIncludes = false);

    TEntity? GettingDriveByBookingId(Guid bookingId, Guid? userId = null, string? roleName = null,
        bool noTracking = true, bool noIncludes = false);

    Task<IEnumerable<TEntity?>> GettingFinishedDrivesWithoutCommentAsync(Guid? userId = null, string? roleName = null,
        bool noTracking = true);

    IEnumerable<TEntity?> GettingFinishedDrivesWithoutComment(Guid? userId = null, string? roleName = null,
        bool noTracking = true);
}