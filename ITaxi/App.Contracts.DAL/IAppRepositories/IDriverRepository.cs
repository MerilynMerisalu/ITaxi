...
public interface IDriverRepositoryCustom<TEntity>
{
    ...
    Task<TEntity> GettingDriverByVehicleAsync(Guid vehicleId, bool noTracking = true, bool noIncludes = false);

    Task<TEntity> GettingDriverByAppUserIdAsync(Guid driverAppUserId, bool noTracking = true, bool noIncludes = false);
